...
trips_df = trips_df.merge(color_df, on="route_id", how="left")
...
async def get_closest_routes(
    ...
    Example: /api/v1/trips/closest_routes?latitude=49.2827&longitude=-123.1207
    ...
    routes_in_radius = routes_in_radius[['route_id', 'shape_id','trip_id', 'trip_headsign', 'color']]
